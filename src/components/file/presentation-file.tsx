...
export default function PresentationFile({ file, handleCheckChange }: {
    file: IFileProps,
    ...
    return <div className="rounded-lg shadow-sm h-32 flex items-end border border-2 flex-col justify-between items-center relative">
        ...
        <div className="rounded-md border border-2 border-orange-700 h-12 w-10 mt-4 relative">
            <div className="absolute w-12 rounded-sm text-center bg-primary left-1/2 -translate-x-1/2 top-1/3">
                <p className="font-bold text-sm text-neutral-50 ">PDF</p>
            </div>
        </div>
